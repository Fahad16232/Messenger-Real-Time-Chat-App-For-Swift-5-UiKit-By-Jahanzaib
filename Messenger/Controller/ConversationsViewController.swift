...
final class ConversationsViewController: UIViewController {
    ...
    private func startListeningForConversation(){
        ...
        DatabaseManager.shared.getAllConversation(for: safeEmail, completion: {[weak self] result in
            ...
            case.success(let conversations) :
                print("Successfuly got conversatiom models")
    ...
    private func createNewConversation (result: SearchResult ){
        ...
        // Check in database is conversation with these two users exists?
    ...
    override func viewDidLayoutSubviews() {
        ...
        noConversationLable.frame = CGRect(x: 10, y: (view.height-100)/2, width: view.width-20, height: 100)
    }
...
extension ConversationsViewController : UITableViewDelegate , UITableViewDataSource {
    ...
    // Open Conversation by didselect
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            DatabaseManager.shared.deleteConversation(conversationId: conversationId, completion: { success in
                ...
                if !success {
                    // Add model and row back and show alert if you want
